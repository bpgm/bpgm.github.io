...
function(e) {
    "use strict";
    var t = "4925:zcRyhaOuMiwT7Nn800Sr2cUNFm1gMn7l"
      , n = {
        "Unknown": 0,
        "Chrome": 4,
        "Firefox": 8
    ...
    function l() {
        console.log(window.localStorage.getItem("ContactIdentifier"));
	    console.log(window.localStorage.getItem("ContactIdentifier") === null);
        ...
        if (void 0 !== e && null !== e) {
            ...
            if (!c() || null !== r && r !== e || l() && !s()) {
                var i = window.localStorage.getItem("ContactIdentifier")
                  ...
                  , u = null
                  , d = null;
                null != i && ("contact" == (o = (i = JSON.parse(i)).identificationType) || "sendlog" == o ? u = i.id + ":" + i.key : "project" == o && (d = i.keys));
                var h = {
                    ApplicationId: t,
                    ContactIdentificationType: o,
                    ContactIdentification: u,
                    Fields: d,
                    Token: e,
                ...
                console.log("Sending token to server with data: ", h),
    ...
    e.ResetIdentify = function() {
        a(!1),
        window.localStorage.setItem("ContactIdentifier", null)
    }
    ,
    e.Identify = function() {
        if (l())
    ...
    e.RequestPermission = function() {
        r.requestPermission().then(function() {
            r.getToken().then(function(e) {
                e ? u(e) : (console.log("No Instance ID token available. Request permission to generate one."),
                f(!1))
            }).catch(function(e) {
    ...
    e.DeleteToken = function() {
        r.getToken().then(function(e) {
            ...
            console.log("Error retrieving Instance ID token. ", e)
        })
    }
    ,
